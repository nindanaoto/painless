...
class SolverInterface
{
  public:
         ...
         */
        virtual void addClause(Painless::ClauseExchangePtr clause) = 0;

        /**
         * @brief Add a list of permanent clauses to the formula.
         * @param clauses The list of clauses to add.
         */
        virtual void addClauses(const std::vector<Painless::ClauseExchangePtr>& clauses) = 0;
         ...
         */
        virtual void addInitialClauses(const std::vector<Painless::ClauseUtils::simpleClause>& clauses, unsigned int nbVars) = 0;
