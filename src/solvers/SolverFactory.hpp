...
using IDScaler = std::function<unsigned(const std::shared_ptr<Painless::SolverInterface>&)>;
...
class SolverFactory
{
  public:
         ...
         */
        static Painless::SolverAlgorithmType createSolver(char type,
                                                                                        char importDbType,
        ...
        static void diversification(
                ...
                const IDScaler& generalIdScaler =
                        [](const std::shared_ptr<Painless::SolverInterface>& solver) { return solver->getSolverId(); },
                const IDScaler& typeIdScaler =
                        [](const std::shared_ptr<Painless::SolverInterface>& solver) { return solver->getSolverTypeId(); });
