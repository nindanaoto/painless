 ...
 * @ingroup localSearch
 */
class YalSat : public Painless::LocalSearchInterface
{
  public:
        ...
        Painless::SatResult solve(const std::vector<int>& cube);
        ...
        void diversify(const Painless::SeedGenerator& getSeed);
