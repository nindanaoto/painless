...
// using Painless::ClauseUtils::simpleClause = std::vector<int>; // Removed, defined in ClauseUtils.hpp

// Forward declaration of Painless::ClauseExchange
class ClauseExchange;

/**
 * @typedef Painless::ClauseExchangePtr
 * @brief Type alias for the smart pointer used to manage Painless::ClauseExchange objects.
 *
...
class ClauseExchange
{
  public:
        ...
        /**
         * @brief Create a new Painless::ClauseExchange object from a vector of literals.
         ...
         */
        Painless::ClauseExchange* toRawPtr()
        {
         ...
         * @param ptr Raw pointer to a Painless::ClauseExchange object.
         * @return Painless::ClauseExchangePtr Smart pointer to the object.
         */
...
/**
 * @brief Increment the reference count of a Painless::ClauseExchange object.
 * @param ce Pointer to the Painless::ClauseExchange object.
 */
inline void
...
/**
 * @brief Decrement the reference count of a Painless::ClauseExchange object and delete if it reaches zero.
 * @param ce Pointer to the Painless::ClauseExchange object.
 */
inline void
