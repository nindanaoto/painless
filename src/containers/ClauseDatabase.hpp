...
class ClauseDatabase
{
  public:
         ...
         */
        virtual bool addClause(Painless::ClauseExchangePtr clause) = 0;
         ...
         */
        virtual size_t giveSelection(std::vector<Painless::ClauseExchangePtr>& selectedCls, unsigned int literalCountLimit ) = 0;

        /**
         * @brief Retrieve all clauses from the database.
         * @param v_cls Vector to be filled with all clauses in the database.
         */
        virtual void getClauses(std::vector<Painless::ClauseExchangePtr>& v_cls) = 0;
         ...
         */
        virtual bool getOneClause(Painless::ClauseExchangePtr& cls) = 0;
